...
def run(playwright: Playwright) -> None:
    ...
    # Click text=自然语言处理：依存分析深度学习进阶系列
    page.click("text=自然语言处理：依存分析深度学习进阶系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af39cc&activeKey=info"
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af39cc&activeKey=info"):
    ...
    # Go to https://momodel.cn/workspace/61efac4727ca1dc4794b8bb9/app
    page1.goto("https://momodel.cn/workspace/61efac4727ca1dc4794b8bb9/app")
