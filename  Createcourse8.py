...
def run(playwright: Playwright) -> None:
    ...
    # Click text=深度学习框架：TensorFlow深度学习基础系列
    page.click("text=深度学习框架：TensorFlow深度学习基础系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=610a2fbb962bbd27d1e7a5a8&activeKey=info"
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=610a2fbb962bbd27d1e7a5a8&activeKey=info"):
    ...
    # Go to https://momodel.cn/workspace/61efa23767a87217644b8bd2/app
    page1.goto("https://momodel.cn/workspace/61efa23767a87217644b8bd2/app")
