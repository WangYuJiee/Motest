...
def run(playwright: Playwright) -> None:
    ...
    # Click text=强化学习Ⅰ深度学习进阶系列
    page.click("text=强化学习Ⅰ深度学习进阶系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af3931&activeKey=info"
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af3931&activeKey=info"):
    ...
    # Go to https://momodel.cn/workspace/61efb09b67a87217644b8c1e/app
    page1.goto("https://momodel.cn/workspace/61efb09b67a87217644b8c1e/app")
