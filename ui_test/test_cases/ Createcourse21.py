...
def run(playwright: Playwright) -> None:
    ...
    # Click text=自然语言处理：NLP中的CNN深度学习进阶系列
    page.click("text=自然语言处理：NLP中的CNN深度学习进阶系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af39f8&activeKey=info"
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af39f8&activeKey=info"):
    ...
    # Go to https://momodel.cn/workspace/61efae32dca63ce48d4b8bbd/app
    page1.goto("https://momodel.cn/workspace/61efae32dca63ce48d4b8bbd/app")
