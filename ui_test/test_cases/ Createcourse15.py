...
def run(playwright: Playwright) -> None:
    ...
    # Click text=自然语言处理：问答系统深度学习进阶系列
    page.click("text=自然语言处理：问答系统深度学习进阶系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af39bc&activeKey=info"
    ...
    page.fill("[placeholder=\"请输入已注册的账户\"]", "l")
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af39bc&activeKey=info"):
    ...
    # with page.expect_navigation(url="https://momodel.cn/workspace/61efaaf067a87217644b8c02/app"):
    with page.expect_navigation():
