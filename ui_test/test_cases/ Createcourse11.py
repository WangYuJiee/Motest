...
def run(playwright: Playwright) -> None:
    ...
    # Click text=计算机视觉：图像关键点检测深度学习进阶系列
    page.click("text=计算机视觉：图像关键点检测深度学习进阶系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af3959&activeKey=info"
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af3959&activeKey=info"):
    ...
    # Go to https://momodel.cn/workspace/61efa68867a87217644b8be9/app
    page1.goto("https://momodel.cn/workspace/61efa68867a87217644b8be9/app")
