...
def run(playwright: Playwright) -> None:
    ...
    # Click text=计算机视觉：语义分割深度学习进阶系列
    page.click("text=计算机视觉：语义分割深度学习进阶系列")
    # assert page.url == "https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af397a&activeKey=info"
    ...
    # with page.expect_navigation(url="https://momodel.cn/classroom/course/detail?id=60eb9ee6bb3e92c927af397a&activeKey=info"):
    ...
    # Go to https://momodel.cn/workspace/61efa60367a87217644b8be5/app
    page1.goto("https://momodel.cn/workspace/61efa60367a87217644b8be5/app")
